...
- **[Workspace](domain/workspace.md)** — The shared operational and authorization context for collaborative Project and Ready-Made Product work. Workspace ownership is distinct from participant access.
- **[Workspace Membership](domain/workspace-membership.md)** — The relationship that records a User's scoped Workspace access relationship, status, role, and granted permission scopes and provides the basis for determining effective Workspace authorization. Membership alone does not automatically produce effective access; Workspace ownership and Organization Membership remain separate.
...
- **[Ready-Made Product](domain/ready-made-product.md)** — The proposed independently stocked physical product configuration for existing-stock commerce. It exists independently from Project and Revision and may be managed without a Listing, but it cannot be publicly offered or purchased directly; buyer-facing purchase requires an applicable Listing that is ACTIVE and effectively orderable.
