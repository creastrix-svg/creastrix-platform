...
- A Project may be created only by a User with sufficient Workspace permissions.
...
- An ACTIVE Project permits development and Revision finalization according to sufficient Workspace permissions.
...
- After a Workspace move, Project access is determined by Workspace Memberships of the target Workspace and is not inherited automatically from the previous Workspace.
...
Detailed Revision lifecycle, finalization, numbering, provenance, and immutable product-data rules belong to the future Revision specification.

Significant Project creation, lifecycle, and Workspace-movement events are recorded through Audit Log.

Detailed Listing rules, including simultaneous Listings for multiple FINALIZED Revisions and active Listing behavior during Project archive or deletion, belong to the future Listing specification.

Royalty allocation and immutable commercial snapshots belong to the future Listing, Order Item, and Royalty specifications. Required historical commercial records must not be retroactively rewritten by later Project lifecycle or Workspace changes.
...
The exact Workspace permission matrix for Project operations remains to be approved.
