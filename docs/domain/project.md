...
- After a Workspace move, Project access is determined by the Membership status, role, and relevant PROJECTS-scope authorization in the target Workspace and is not inherited automatically from the previous Workspace.
